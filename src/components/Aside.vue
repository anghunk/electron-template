<template>
  <aside class="w-[220px] h-[calc(100%-32px)] overflow-y-auto m-4 bg-surface flex flex-col rounded-theme shadow-card border border-border-light [&::-webkit-scrollbar]:hidden">
    <div class="py-6 px-5 flex flex-col justify-center items-center gap-3 border-b border-border-light">
      <span class="font-heading text-base font-bold text-text tracking-wide whitespace-nowrap">Electron Template</span>
    </div>
